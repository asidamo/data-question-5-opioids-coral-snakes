...
opioids_ranges<-opioids_per_NPI%>%
  transmute(first_20_pct=cummulativePct<20,second_20_pct=(cummulativePct>=20 & cummulativePct<40),third_20_pct=(cummulativePct>=40 & cummulativePct<60),
            fourth_20_pct=(cummulativePct>=60 & cummulativePct<80),fivth_20_pct=(cummulativePct>=80))
...
race<-read.csv('./Data/PEP_2014_PEPSR6H_with_ann.csv')
...
insurance<-read.csv('./Data/hic04_acs.csv')
